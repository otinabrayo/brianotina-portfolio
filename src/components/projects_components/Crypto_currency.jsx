...
function Crypto_currency() {
  ...
  <ul className="list-disc ml-5 space-y-2 text-gray-700 dark:text-gray-300 mb-10">
    ...
    target="_blank"
    className="text-xl text-blue-500 mb-6 animate animate-pulse hover:underline"
  >
  ...
  <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">
    Data Source: <a href="https://www.coingecko.com/en/api" className="text-blue-500 hover:underline">CoinGecko API</a>
  </p>
</section>
